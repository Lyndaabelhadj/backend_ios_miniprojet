...
///////////////////////////////////////////////////////////////////////////////
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "vidoccontact@gmail.com",
      pass: "ninrjmgcidawekmd",
    },
  });
  ///////////////////////////////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////////
...
export const updateScoreNew = async (req, res) => {
...
export const ChangePassword = async (req, res, next) => {
  ...
  if (!email || !oldPassword || !newPassword) {
    ...
    try {
      ...
      if (!savedUser) {
        return res.status(422).json({ error: "invalid email or password55" });
      }
      ...
      const hasedNewPassword = await bcrypt.hash(newPassword, salt);

      const domatch = await bcrypt.compare(oldPassword, savedUser.password);
      if (domatch) {
        ...
        return res.status(422).json({ error: "invalid email or password777" });
      }
    } catch (error) {
      console.log(error);
